...
(function (global) {
  ...
  global.ViewComponents.ModalView = {
    setup() {
      ...
      const cModal = `<x-modal v-model="open" title="提示信息">
  <p>弹窗内容</p>
  <template #footer>
    <x-button @click="open = false">取消</x-button>
    <x-button variant="primary" @click="open = false">确定</x-button>
  </template>
</x-modal>`;
      return { t, open1, open2, cModal };
    },
    template: `
      <div class="view-page">
        ...
        <x-waterfall :columns="2" :gap="16">
          <x-demo-block title="基础弹窗" :code="cModal">
            <x-space size="lg">
