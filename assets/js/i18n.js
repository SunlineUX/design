  ...
  'zh-CN': {
    ...
    nav: {
      ...
      systemRoles: '角色管理',
        ...
        doneTickets: '已办工单',
        applications: '数据应用',
        managementCockpit: '管理驾驶舱',
        decisionPortal: '决策信息门户',
        operationsSystem: '运营管理系统',
        analysis: '运营分析',
        analysisOverview: '运营总览',
        analysisReports: '运营分析报表',
      settings: '设置',
      appSettings: '应用设置',
      userCenter: '个人中心',
    },
  ...
  'en-US': {
    ...
    nav: {
      ...
      settings: 'Settings',
        ...
        dataApply: 'Data Application',
        toolMall: 'Tool Mall',
        reports: 'Reports',
        dashboards: 'Dashboards',
        selfAnalysis: 'Self-service Analysis',
        ...
        decisionPortal: 'Decision Portal',
        operationsSystem: 'Operations System',
        analysis: 'Operations Analysis',
        analysisOverview: 'Operations Overview',
        analysisReports: 'Operations Reports',
